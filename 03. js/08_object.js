...
// 객체 프로퍼티 참조 : 객체 프로퍼티 값을 읽는다. 객체.프로퍼티의 형식으로,
...
// console.log(user.color.bg); //undefined,null 한테 프로퍼티를 참조하면 오류 발생!
console.log(user.color?.bg); //옵셔널 체이닝. undefined거나 null 참조 x.
