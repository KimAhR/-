...
console.log(a + 1); //선언부만 호이스팅 되기 때문에 undefined + 1의 결과 Nab 출력.
var a = 10;
...
/*
  콜백함수(callback)
    ...
    - JS에서 함수를 값으로 평가하기 때문에 가능하다.
    => 콜백함수로서 값을 전달할 때는 호출하는 형태가 되면 안된다.  
...
console.log(result03, result05);

// 인자 n을 전달받아서 함수를 n번 반복 실행하는 함수 만들기.
...
/*
  sum03을 사용해서 숫자 5,7 를 더한 값을 7번 출력하기
  1. sum03을 사용한다. 인자로는 5,7
  2. console.log() 결과를 출력한다.
  3. reapeat 함수를 통해서 위 과정을 7번 반복한다.
