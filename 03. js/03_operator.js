...
// 전위 연산자 : 단항 연산자가 앞에 붙으면 우선순위가 가장 먼저다.
console.log(num++);
console.log(num);
...
num03 += 30;
// num03(120)에 30을 더한 값을 num03에 다시 할당.
num03 /= 2;

// 비교 연산자 : 좌항과 우항을 비교하여 true 혹은 false를 반환.
// 동등 연산자
console.log(1 == 3); // false
console.log(1 == "1"); // 동등연산자를 사용하면 숫자1과 문자열 "1"을 동등하게 본다.
...
/* 
  논리연산자 : 두 논리값을 가지고 새로운 값.
  ||(or) : 두 값 중 하나라도 true라면 true 반환 => 둘 다 false일 때만 false 반환.
  &&(and) : 두 값 모두 true일때만  true => 둘 중 하나라도 false라면 false 반환.
  ! : 논리값을 반전시킨다. => true -> false, false -> true
*/
console.log(num04 > 10 || num05 >= 10); // true or false이기 때문에 true
console.log(num04 < 10 && num05 > 4); // true and true 이기 때문에 true
console.log(!(num04 < 10)); // not true이기 때문에 false

// 문자열 연결 연산자 : 좌항과 우항의 문자열을 연결
var str = "안녕하세요" + "김아름입니다.";
console.log(str);
age = 31;
